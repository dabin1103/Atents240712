...
namespace _01_Console
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //    Console.WriteLine("Hello");
            //    count++;
            //} while (count < 3);      // do-while : 우선 {} 사이의 코드를 실행하고 () 사이의 조건이 참이면 {}를 반복실행한다.
            ...
            // 7/15------------------------------------------------
            //Console.WriteLine("저는 윤다빈입니다. 나이는 25살입니다.");
            //int age = 25;
            //Console.WriteLine("저는 윤다빈입니다. 나이는 " + age + "살입니다.");  // 절대 비추천
            //// 합칠 때는 이런 방식으로 처리. 쌍따옴표앞에 $붙이고 변수는 {} 사이에 넣기
            //Console.WriteLine($"저는 윤다빈입니다. 나이는 {age}살입니다.");      
            ...
            // if-else : () 사이에 있는 조건이 true면 if아래에 있는 {} 사이의 코드를 실행,
            // false면 else 아래에 있는 {} 사이의 코드를 실행
            //if(age > 20)
            //{
            //    Console.WriteLine("성인입니다.");
            //}
            ...
            // 비교연산자 : <, >, <=, >=, ==(같다), !=(다르다), 항상 결과는 true아니면 false
            ...
            //Console.WriteLine("Hello, World!윤");
            //Console.WriteLine("Hello, World!다빈");
            //Console.WriteLine("dbsekqls");
